export default () => {
  const viewSignUp = `
    ...
    <div class="logo-principal"><img src="./assets/logo-limatopia.png" /></div><button class="content-about">
      <p>ABOUT US</p>
    </button>
  </header>
      ...
      <section class="sectionSon">
        ...
        <section id="containerLogIn">
          ...
          <section class="sectionNetworks">
            <img src="./assets/g.jpg" alt="Gmail" id="gmail" /><img src="./assets/fb.jpg" alt="Facebook"
              id="facebook" /></section>
          <section class="loginButton disabled-button">
            <section class="loginButtonSon"><button type="submit" id="btnSignUp" class="SignUp-button">Sign up</button>
            </section>
          </section>
