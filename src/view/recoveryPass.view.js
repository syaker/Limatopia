export default () => {
  const forgotPass = `
    ...
    </div><br><span id="messageSend"></span><br><button class="sendEmail">ENVIAR</button><a href="#/"><input class="regresar" type="button" value="REGRESAR" name="Regresar" spellcheck="false"></a></form> </section>`;
